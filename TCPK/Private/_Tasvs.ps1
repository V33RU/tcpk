...
$script:TcpkTasvsMap = @(
    ...
    @{ rx='^(tls-bypass|tlspinning|tlsprotocols|tls\.|insecureschemes|scheme|crlocsp|backend|endpoints|dnsleakage|selfhost|truststore)'; tasvs=@('TASVS-NETWORK Network Communication'); da=@('DA7 Insecure Communication') }
