...
TCPK runs 329 cmdlets across 19 buckets (221 of them detection checks), streams findings live, and writes HTML + Excel
...
TCPK v2.11.0 - see [`README.txt`](README.txt) for the full manual and `docs/` for methodology.
