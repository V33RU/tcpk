...
TCPK runs 327 cmdlets across 19 buckets (220 of them detection checks), streams findings live, and writes HTML + Excel
...
TCPK v2.10.0 - see [`README.txt`](README.txt) for the full manual and `docs/` for methodology.
